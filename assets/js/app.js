...
document.addEventListener('DOMContentLoaded', () => {
    ...
    if (window.innerWidth >= 700) {
        const statsLogos = document.querySelector('.stats__logos');
        
        setInterval(() => {
            const newStatsLogo = document.createElement('img');
            newStatsLogo.classList.add('stats__logo');
            newStatsLogo.setAttribute('src', 'assets/img/logo-big.png');
            statsLogos.appendChild(newStatsLogo);
